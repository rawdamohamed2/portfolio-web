...
export default function ProjectCard({ project }) {
  ...
  return (
    <div
      ...
      data-aos-delay="300"
    >
      <div className="card min-h-[500px] bg-primary border-0 rounded-2xl overflow-hidden h-full duration-300 transition-all hover:shadow-[0px_0px_8px_#00FFF7] transform hover:scale-[1.02] hover:translate-y-[-20px]">
        <img
          src={project.image}
          ...
          loading="lazy"
        />
        <div className="card-body bg-primary overflow-hidden md:px-3 p-0 py-3">
